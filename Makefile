...
ARCH            ?= arm
CROSS_COMPILE   ?= /mnt/android/toolchains/arm-eabi-4.8/bin/arm-eabi-
...
AFLAGS_MODULE   =
LDFLAGS_MODULE  =
FLAGS_KERNEL	= -mcpu=cortex-a15 -mtune=cortex-a15 -mfpu=neon-vfpv4 -ffast-math -ftree-vectorize -pipe
